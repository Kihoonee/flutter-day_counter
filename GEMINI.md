...
**Layer 3: 실행 (작업 수행)**
- `.agent/skills/` 폴더의 결정론적 Dart 스크립트 또는 CLI 도구
...
**1. 도구부터 확인**
스크립트를 작성하기 전에 지시에 따라 `.agent/skills/` 폴더를 확인하세요. 기존 도구가 없을 때만 새 스크립트를 생성합니다.
...
컴파일에러/런타임에러는 학습 기회입니다. 무언가 망가지면:
1. 고친다
2. 도구를 업데이트한다
3. 도구를 테스트하고 작동 확인
...
- `.agent/skills/` - Dart 스크립트 및 유틸리티 (결정론적 도구)
